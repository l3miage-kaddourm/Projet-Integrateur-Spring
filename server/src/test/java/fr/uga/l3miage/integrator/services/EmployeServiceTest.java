...
//    @Test
//    public void getLivreurs_ShouldReturnLivreurs_WhenTheyExist() throws NotFoundEmployeException {
//        // Given
...
//    }
    ...
    @Test
    public void getLivreurs_ShouldThrowNotFoundLivreursRestException_WhenNoLivreursFound() throws NotFoundEmployeException {
        // Given
        when(employeComponent.findAllLivreurs()).thenThrow(new NotFoundEmployeException("Aucun Livreur Trouvé"));

        // When & Then
        NotFoundEmployeRestException thrown = assertThrows(
                NotFoundEmployeRestException.class,
